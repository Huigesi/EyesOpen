package me.huigesi.eyesopen.app.base;
...
public class DefaultsFooter extends InternalClassics<DefaultsFooter> implements RefreshFooter {
    ...
    public DefaultsFooter(Context context) {
        this(context, null);
    }

    public DefaultsFooter(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DefaultsFooter(Context context, AttributeSet attrs, int defStyleAttr) {
