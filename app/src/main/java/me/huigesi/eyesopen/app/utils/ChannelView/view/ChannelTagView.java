package me.huigesi.eyesopen.app.utils.ChannelView.view;
...
import me.huigesi.eyesopen.app.utils.ChannelView.adapter.GroupedListAdapter;
...
import me.huigesi.eyesopen.app.utils.ChannelView.util.MeasureUtil;
...
public class ChannelTagView extends LinearLayout {
    ...
    public ChannelTagView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        categoryAddedBannerBg = array.getResourceId(R.styleable.channel_tag_style_addedCategroyTitleBg, R.color.colorWhite);
        categoryUnAddedBannerBg = array.getResourceId(R.styleable.channel_tag_style_unAddedCategroyTitleBg, R.color.colorWhite);
