...
public class News163Fragment extends BaseRecyclerFragment<News163Presenter> implements News163Contract.View {
    public static final String NEWS163_ID = "mId";
    private ItemNewsAdapter mAdapter;
    private LinearLayoutManager mLayoutManager;
    private String mId,mNewsType;

    public static News163Fragment newInstance(String id) {
